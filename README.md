...
## 🇺🇸 EN — About
The Techn&Art Portal is a website developed in **PHP + MySQL**, consisting in a **front-office** and a **back-office**.
...
### Notes
The code in the **master branch** served as the base.  
The design and functionality improvements made by my team in both the back-office and front-office were implemented and consolidated in the **sub-master branch**.
