...
<?= template_header('Zoltán Somhegyi'); ?>
...
<section>
    <div class="totall">
        ...
        <div id="resto" class="infoCorpo">
            <img style="object-fit: cover; width:255px; height:310px; padding-left: 50px; padding-top: 50px" src="./assets/images/ZoltanSomhegyi.png" alt="">
            ...
            <div class="textInfo" style="padding-bottom: 80px;">
                <?= change_lang("about-ZoltanSomhegyi") ?>
            </div>
