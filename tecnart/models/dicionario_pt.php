...
function ret_dic_pt(){
    ...
    $dic_pt = array(
        ...
        "about-ZoltanSomhegyi" => "Zoltán Somhegyi é historiador de arte, doutorado em Estética pela Universidade da Igreja Reformada Károli Gáspár, na Hungria, onde é Professor Adjunto. Como investigador, é especializado em arte e teoria da arte dos séculos dezoito e dezanove, tendo também como campos de interesse as Belas-Artes contemporâneas e a crítica artística. É o Secretário Geral e o editor do portal da Associação Internacional de Estética, membro do Comité Executivo do Conselho Internacional para a Filosofia e Ciências Humanas, consultor para o Mercado de Arte de Budapeste: Feira Internacional de Arte Contemporânea, e Chefe de Redação da revista HAS – Humanities, Arts & Society.",
